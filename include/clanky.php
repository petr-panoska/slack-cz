...
$sql = "SELECT * FROM clanky WHERE viditelnost=1 ORDER BY datum DESC";
$req = $link->query($sql);
if($req){
...
?>
<br />
<a href="http://www.slacklive.cz/clanky/nahledy.htm">Starší články</a>
<br /><br />
<a href="/novy_clanek-1">Přidání článku</a>