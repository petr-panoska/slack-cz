 ...
 */
class Gps extends \Slack\Models\Gps implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Slack\\Models\\Gps' . "\0" . 'id', '' . "\0" . 'Slack\\Models\\Gps' . "\0" . 'lat', '' . "\0" . 'Slack\\Models\\Gps' . "\0" . 'lng', '' . "\0" . 'Slack\\Models\\Gps' . "\0" . 'type'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gps $proxy) {
