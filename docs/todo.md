...
- [ ] **Mobil: přechody na `/mapa`** (2026-07-05) — box Přechody je na mobilu schovaný (`_map.scss`, TODO(mapa-mobile)); vymyslet, jak je zakomponovat do mobilního ovládání (box Lajny už jede jako tlačítko vlevo nahoře → rozbalovací seznam max ⅓ displeje).
