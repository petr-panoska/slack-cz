...
#[ORM\Entity(repositoryClass: LinePhotoRepository::class)]
#[ORM\Table(name: 'line_photo')]
#[ORM\Index(columns: ['line_id', 'created_at'], name: 'idx_line_photo_line_created')]
#[Vich\Uploadable]
class LinePhoto
{
    #[ORM\Id]
    ...
    /** Legacy `line_foto.id` for gallery photos; NULL for covers and user uploads. */
    ...
    #[Vich\UploadableField(mapping: 'line_photo', fileNameProperty: 'filename')]
