...
#[ORM\Table(name: 'line')]
#[UniqueEntity(fields: ['name'], message: 'Line s tímto názvem už existuje')]
class Line
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\Column(length: 32, enumType: LineType::class)]
    private LineType $type = LineType::Unsorted;
    ...
    private ?LinePhoto $coverPhoto = null;
    ...
    /** Author of the line submission. NULL for legacy imports. */
    ...
    public function setType(LineType $type): static
    {
        $this->type = $type;
        return $this;
    }
    ...
    public function getCoverPhoto(): ?LinePhoto
    {
        return $this->coverPhoto;
    }

    public function setCoverPhoto(?LinePhoto $coverPhoto): static
    {
