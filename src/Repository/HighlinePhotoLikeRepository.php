...
/**
 * @extends ServiceEntityRepository<HighlinePhotoLike>
 */
class HighlinePhotoLikeRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, HighlinePhotoLike::class);
    }

    public function findOneByPhotoAndUser(HighlinePhoto $photo, User $user): ?HighlinePhotoLike
    {
